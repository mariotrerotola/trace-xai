...
extract_stable_rules(X, *, y=None, n_estimators=20, frequency_threshold=0.5,
                     ...
                     random_state=42) -> ExplanationResult
```
...
| Class | Key Fields |
|-------|------------|
| `ExplanationResult` | `rules`, `report`, `surrogate`, `train_report`, `pruned_rules`, `pruning_report`, `monotonicity_report`, `ensemble_report`, `stable_rules` |
...
│   ├── monotonicity.py        # MonotonicityReport, validate_monotonicity
